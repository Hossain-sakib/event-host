            ...
            <div className="flex flex-col items-center justify-center mt-12 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-8">
                    <div className="card p-4 w-96 shadow-xl bg-indigo-600 bg-opacity-10 space-y-4 relative">
                        <img className="relative" src="/src/assets/resources/Rectangle 16.png" />
                        <div className="absolute z-10 top-4 left-4 right-4 flex items-center justify-between px-4 pointer-events-none">
                            ...
                            <a className="bg-indigo-500 text-white px-3 rounded-md flex items-center gap-2 pointer-events-auto"><img src="/src/assets/resources/icon/Heart.png" alt="" />Favorite</a>
                        </div>
                    ...
                    <div className="card p-4 w-96 shadow-xl bg-indigo-600 bg-opacity-10 space-y-4 relative">
                        <img className="relative" src="/src/assets/resources/Rectangle 16-1.png" />
                        <div className="absolute z-10 top-4 left-4 right-4 flex items-center justify-between px-4 pointer-events-none">
                            <a className="bg-indigo-500 text-white px-3 rounded-md pointer-events-auto">Online</a>
                            <a className="bg-indigo-500 text-white px-3 rounded-md flex items-center gap-2 pointer-events-auto"><img src="/src/assets/resources/icon/Heart.png" alt="" />Favorite</a>
                        </div>
                    ...
                    <div className="card p-4 w-96 shadow-xl bg-indigo-600 bg-opacity-10 space-y-4 relative">
                        <img className="relative" src="/src/assets/resources/Rectangle 16-2.png" />
                        <div className="absolute z-10 top-4 left-4 right-4 flex items-center justify-between px-4 pointer-events-none">
                            <a className="bg-indigo-500 text-white px-3 rounded-md pointer-events-auto">Online</a>
                            <a className="bg-indigo-500 text-white px-3 rounded-md flex items-center gap-2 pointer-events-auto"><img src="/src/assets/resources/icon/Heart.png" alt="" />Favorite</a>
                        </div>
