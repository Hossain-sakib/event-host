            ...
            <div className="grid grid-cols-2 md:grid-cols-4  gap-8">
                <div className="card p-6 w-64   bg-indigo-600 bg-opacity-10 space-y-4 ">
                    <div className="btn btn-circle">
                        <img src="/public/resources/icon/click (1) 1.png" />
                    </div>
                ...
                <div className="card p-6 w-64   bg-indigo-600 bg-opacity-10 space-y-4 ">
                    <div className="btn btn-circle">
                        <img src="/public/resources/icon/click.png" />
                    </div>
                ...
                <div className="card p-6 w-64   bg-indigo-600 bg-opacity-10 space-y-4 ">
                    <div className="btn btn-circle">
                        <img src="/public/resources/icon/check 1.png" />
                    </div>
                ...
                <div className="card p-6 w-64   bg-indigo-600 bg-opacity-10 space-y-4 ">
                    <div className="btn btn-circle">
                        <img src="/public/resources/icon/Vector-1.png" />
                    </div>
